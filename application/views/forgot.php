...
<div class="bgImageJumbotron">
   <br><br><br>
	 <form class="form-signin" method="POST" action="<?php echo base_url(); ?>auth/newPassword" style="background-color:#fff;padding:40px">
      ...
      <div class="form-group">
		 ...
		 <input type="text" name="newPassword" class="form-control form-control-lg" placeholder="First Name" required autofocus>
	    </div>
