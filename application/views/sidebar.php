<ul class="list-group">
 ...
 <li class="list-group-item openMenu <?php echo ($this->uri->segment(1) == "quiz") ? "bg-info" : "";?>" data-href="<?php echo base_url();?>quiz">Take Quiz <br><small><?php echo $reports['total_quiz'];?>+ quiz available</small><span class="badge badge-info float-right"><?php echo $reports['total_quiz'];?></span></li>
 ...
 <li class="list-group-item openMenu <?php echo ($this->uri->segment(1) == "my-quiz") ? "bg-info" : "";?>" data-href="<?php echo base_url();?>my-quiz">My Quiz <span class="badge badge-info float-right"><?php echo $reports['quiz_taken'];?></span></li>
