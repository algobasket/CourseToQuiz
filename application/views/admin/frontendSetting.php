  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    ...
    <div class="alert alert-dark" role="alert">
      <h5>Frontend Settings  <a href="<?php echo base_url();?>admin/setting/frontend/create" class=" btn btn-primary btn-sm float-right">Add New Frontend</a></h5>
   </div>
   ...
   <div class="container">
     <table class="table">
      ...
      <tr>
        ...
        <td><?php echo substr($r['json_data'],0,50);?>....<a href="<?php echo base_url();?>admin/setting/frontend/view/<?php echo $r['id'];?>">Show</a></td>
        ...
        <td>
          <a href="<?php echo base_url();?>admin/setting/frontend/view/<?php echo $r['id'];?>" class="btn btn-primary btn-sm">View</a> |
          <a href="<?php echo base_url();?>admin/setting/frontend/edit/<?php echo $r['id'];?>" class="btn btn-primary btn-sm">Edit</a> |
          <a href="<?php echo base_url();?>admin/setting/frontend/delete/<?php echo $r['id'];?>" class="btn btn-primary btn-sm">Del</a>
        </td>
      <?php $i++;} ?>
     </tr>
   </tbody>
 ...
 <?php }elseif($section=='create'){ ?>
   <div class="alert alert-dark" role="alert">
     <h5>Create New Frontend</h5>
  </div>
  <div class="container">
  <?php echo form_open('admin/setting/frontend/create') ;?>
   <div class="form-group">
     <label for="exampleInputEmail1">Frontend Name</label>
     <input type="text" class="form-control" placeholder="Enter Frontend Name" name="setting_name"/>
     <small id="emailHelp" class="form-text text-muted">Use frontend name specific to the page layout</small>
