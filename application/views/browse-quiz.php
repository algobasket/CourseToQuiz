   ...
   <div class="form-group">
    ...
    <div class="input-group input-group-lg">
      <div class="input-group-prepend">
        <span class="input-group-text" id="inputGroup-sizing-lg">Browse Quiz</span>
      </div>
      <input type="text" placeholder="Search your quiz.." class="form-control searchCourse2" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
    </div>
